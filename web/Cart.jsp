                                        ...
                                        <table>
                                            <c:forEach items="${cartx}" var="c">
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div>${c.name}</div>
                                                        <div><h7><span style="color: green">Description: </span><div  style="overflow-y: scroll; height: 40px; word-wrap: break-word;"> <c:out value="${c.description}"/></div></h7></div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="key">
                                                            <input type="text"  onblur="setHref(this.value,${c.id})" placeholder="Quantity" value="${c.quantity}" style="color: black;">
                                                            <div class="clearfix"></div>
                                                        </div>
                                                    </td>
                                                    <td><a id="${c.id}" class="hyper" href="AddToCart?prodId=${c.id}&quant=${c.quantity}" value="${c.quantity}"><span><input type="button" value="update" style="color: black; background: transparent;" id=""/></span></a></td>
                                                </tr>
                                                <tr>
