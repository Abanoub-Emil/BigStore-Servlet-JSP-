                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav ">
                                ...
                                <li name="allcat" id="allcat" value ="allcat" onclick="getCat(this)"><a class="hyper"><span>all</span></a></li>                               
                                    ...
                                    <li name="${category}" id="${category}" value ="${category}" onclick="getCat(this)"><a class="hyper"><span><c:out value="${category}"/></span></a></li>
                                            </c:forEach>
                                <li name="maxP" ><a class="hyper" ><span><input type="text" placeholder="Max price" style="color: black;" id="maxP"/></span></a></li>
                                <li name="maxPBut" ><a class="hyper" ><span><input type="button" value="Search" onclick="searchP()" style="color: black; background: transparent;" id="maxPBut" on/></span></a></li>
                            </ul>   
